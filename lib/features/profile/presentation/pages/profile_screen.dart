        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              // Legal & Meta-Search Settings Section
              Text(
                'الإعدادات والمعلومات القانونية • Settings & Legal',
                style: Theme.of(context).textTheme.titleMedium?.copyWith(
                      fontWeight: FontWeight.bold,
                      color: AppTheme.primaryNavy,
                    ),
                  ...
                  children: [
                    ListTile(
                      leading: Container(
                        ...
                        child: const Icon(Icons.gavel, color: AppTheme.accentBlue, size: 20),
                      ),
                      title: const Text('شروط الاستخدام والخصوصية', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 14)),
                      subtitle: const Text('Terms of Service & Privacy Policy (Meta-Search)', style: TextStyle(fontSize: 12, color: AppTheme.textMuted)),
                    ...
                    ListTile(
                      ...
                      title: const Text('معمارية البحث والمقارنة المباشرة', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 14)),
                      subtitle: const Text('TravelGo 0% Commission Meta-Search Protocol', style: TextStyle(fontSize: 12, color: AppTheme.textMuted)),
                      trailing: Container(
                        ...
                        child: const Text('0% Markup', style: TextStyle(color: Colors.green, fontWeight: FontWeight.bold, fontSize: 11)),
                      ),
                    ),
                  ],
                ),
